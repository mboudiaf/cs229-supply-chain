...
def eval_agent(agent,environment,experiment,prod_val,price_val,horizon=24):
    ...
    for prod,price in zip(prod_val,price_val):
        ...
        battery_states_day,h2_vessel_states_day,regime_e_day,flow_g_day,_=experiment.doInteractions(horizon,test=True)
...
def read_generated_energy(file_solar, file_wind):
    ...
    #inputs :
    #       -file_solar : string name of the path to file
    #       -file_wind : string name of the path to file
    #outputs :
    #       -table : 
    ...
    for rownum in range(4,sh_solar.nrows):
       ...
       if (date_solar != date_wind) :
           ...
           if (date_solar.minute == 45) :
               table = table + [[date, s_solar/4, s_wind/4] ]
               s_solar = 0
               s_wind = 0
...
def read_electricity_price (file_price, country, energy_table):
    ...
    #inputs :
    #       -file_price :
    #       -country : String name of the country considered
    #       -energy_table : 
    #read excel files
